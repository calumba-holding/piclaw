...
} from "../../../src/channels/web/runtime-state-service.js";
import type { ChatRunControlStore } from "../../../src/channels/web/chat-run-control.js";
import type { WebRecoveryStore } from "../../../src/channels/web/recovery.js";
...
describe("web runtime state service", () => {
  ...
  test("recovery helpers use live assistant identity plus queue/process wiring", async () => {
    ...
    expect(processed).toEqual([
      { chatJid: "web:replay", agentId: "default", threadRootId: undefined },
