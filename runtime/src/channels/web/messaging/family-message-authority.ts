...
export function admitFamilyMessage(actor: AuthenticatedPrincipal, input: { chatJid?: string; content: string; requestId: string; threadId?: number | null; mode?: FamilyTurnAdmissionMode }) {
