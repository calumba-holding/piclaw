...
- Follow-up gaps were split out rather than left implicit, including `workitems/50-done/katex-css-font-vendor-provenance.md`.
...
- `workitems/20-doing/fix-mermaid-vendor-build.md`
